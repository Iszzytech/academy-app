...
<body>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12 text-right">
                                        <ul class="breadcome-menu">
                                            <li><p id="textP" style="font-weight: bold; display: none;">Exam Ends in:</p><div id="countdowntimer" style="display: none; font-size: 20px; color: red; font-weight: bold;"></div>
                                            </li> 
    ...
    function timer()
    {
        var messaging =  document.getElementById("textP");
        ...
        xmlhttp.onreadystatechange=function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                else if (xmlhttp.responseText == "00:00:00"){
