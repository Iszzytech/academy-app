...
<div class="row" style="margin: 0px; padding:0px; margin-bottom: 50px;">
            ...
            <div class ="row">
                ...
                <span style="padding-left:30px; font-size: 16px; font-weight: bolder; color:#006DF0;"> <div id="current_que" style="float:left">0 </div>
                        <div style="float:left">/</div>
                        <div id="total_que" style="float:left">0 </div></span>
                </div>
...
<script type="text/javascript">
       ...
       xmlhttp.send(null);
        ...
        function load_questions(questionno)
        {
          ...
          xmlhttp.open("GET","forajax/load_correct_questions.php?questionno="+questionno, true);
          xmlhttp.send(null);
        }
